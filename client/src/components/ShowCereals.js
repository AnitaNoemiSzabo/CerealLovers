    ...
    render() {
      return (
          <div>
            ...
            <div className="gender_link">
              <Link to="/gender" style={{textShadow: '2px 2px 2px #000000', fontSize: '20px', fontWeight: 'bold', color: 'pink', textDecoration: "none"}}>Who do you want to meet?</Link>
            </div>
          </div>
      );
    }
